...
> **الحالة: المرحلة الثالثة (Phase 3).** إلى جانب فلترة DNS المحلية (المرحلة 2)،
> أُضيفت: **البحث الآمن** (SafeSearch) لـ Google وBing وDuckDuckGo وYouTube،
> **طبقة قواعد لفحص البحث** قابلة لاستبدالها بالذكاء الاصطناعي في المرحلة 4،
> **حماية التطبيقات** عبر خدمة تسهيل استخدام محدودة الصلاحيات، و**سجل أحداث
> يحفظ الخصوصية**.
>
...
> (Flutter 93، Kotlin 90) وطبقة Android مُتحقق من ترجمتها فقط. انظر
...
|---|---|---|
| Flutter (`flutter test`) | 93 | ✅ (منها 20 للمرحلة 3) |
| Kotlin JUnit (المحرك) | 90 | ✅ (منها 45 للمرحلة 3)، شُغّلت عبر أداة JVM لأن `./gradlew test` يحتاج Android SDK |
...
التفاصيل: [`docs/PHASE_3_TESTING.md`](docs/PHASE_3_TESTING.md) (المرحلة 3)،
...
- **قبل أي شيء:** بناء APK واختبار المراحل 2 و3 يدويًا على جهاز حقيقي.
- **المرحلة 4 (الذكاء الاصطناعي):** مصنّف بحث محلي خلف `SearchClassifier`،
  تصنيف نطاقات مجهولة خلف `DomainClassifier`، ومصدر أحداث `AI`.
