...
> **الحالة: المرحلة الثامنة (Phase 8): قابلية الصيانة والتحديثات والمراقبة.** الإصدار 1.7.0.
> ما أُضيف:
> - مراقبة صحة مستمرة أثناء عمل VPN، مع إصلاح محدود بتراجع أُسّي
> - تنبيه اختياري عند توقف الحماية
> - تفسير موحد لكل قرار حظر أو سماح، وتتبّع قرارات بلا محتوى
> - مدقق وحافظ تحديثات موقّعة للقوائم والنموذج (بلا خادم أو نقل بعد)
> - تقارير أعطال محلية
> - إحصاءات اختيارية متوقفة افتراضيًا ولا تُرسل
> - نظام ملاحظات بمعاينة دقيقة لما يُشارك
> - نسخة احتياطية خاصة لقوائم المستخدم تُستعاد بعد تلف قاعدة البيانات
> - CI/CD
>
...
>
> **ليس جاهزًا للإنتاج بعد:** لم يُبنَ إصدار release يدويًا، ولم تُختبر المراحل 6–8 على جهاز حقيقي.
>
