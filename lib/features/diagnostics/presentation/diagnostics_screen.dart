...
class _DiagnosticsScreenState extends State<DiagnosticsScreen> {
  ...
  static String _label(String key) => switch (key) {
    ...
    'shieldState' => tr('درع المحتوى الذكي', 'AI Content Shield'),
    'shieldImageModel' => tr('نموذج صور الدرع', 'Shield image model'),
    'shieldAccessibility' => tr('خدمة درع المحتوى', 'Content Shield service'),
